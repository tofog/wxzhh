...
- （三）虎码造词
    ...
    3. 个人自定义词典（不参与组句）：在custom_phrase文件夹创建user.txt文件，按照：每行1条文本 的格式编辑，部署即自动生成虎码简词，作为官虎词的补充
- （四）候选词手动调序
...
## 更新日志
- 7.25：修复文件简词3字词编码生成错误的问题、新增Z前缀文件检索与管理功能、恢复快符a、调整了英文开关逻辑（ctrl+m开启）、增加虎码英文混合词汇
